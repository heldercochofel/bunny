...
class UserProfileTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('UserProfile') ? [] : ['className' => UserProfileTable::class];
        $this->UserProfile = TableRegistry::getTableLocator()->get('UserProfile', $config);
    }
